...
const AddContact = () => {
    ...
    return (
        <div className='add-contact-container container-fluid'>
            <h1 className='display-3 text-center fw-bold add-contact-title'>Add Contact</h1>
            <div className='row'>
                <div className='col-md-6 shadow mx-auto my-5 p-5 add-contact'>
