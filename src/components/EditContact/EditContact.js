...
const EditContact = () => {
    ...
    return (
        <div className='container-fluid edit-contact-container'>
            {
                currentContact ? (
                    <>
                        <h1 className='display-3 text-center fw-bold edit-contact-title'>Edit Contact</h1>
                        <div className='row'>
                            <div className='col-md-6 shadow mx-auto my-5 p-5  edit-contact'>
